...
IMAGE_SIZE = (224, 224)
NUM_CLASSES = 18
TRAIN_DIR = 'C:/my_project2/alcogole/Wiskey/learning'
VALID_DIR = 'C:/my_project2/alcogole/Wiskey/valid'
...
def train_model():
    ...
    history = model.fit(
        ...
        callbacks=[
            ...
            ModelCheckpoint('best_modecl.keras', monitor='val_accuracy', save_best_only=True)
        ]
    )
    
    # Сохранение и вывод результатов
    model.save('final_mocdel.keras')
